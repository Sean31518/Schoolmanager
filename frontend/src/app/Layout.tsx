...
function SidebarFooterRow({
  ...
  return (
    <div className="mt-auto flex items-center gap-2 border-t border-border pt-3">
      ...
      <span className="flex-1 truncate text-xs text-text-secondary">{userName}</span>
      <NavLink
        to="/settings"
        onClick={onNavigate}
        title="Einstellungen"
    ...
    <div className="flex min-h-dvh flex-col bg-bg-0 font-sans text-text-primary md:flex-row">
      <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border bg-bg-2 px-4 md:hidden">
        <button
          ...
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-text-secondary hover:bg-bg-hover"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      {collapsed ? (
        <aside className="hidden w-11 shrink-0 flex-col items-center gap-3 border-r border-border bg-bg-2 py-4 md:flex">
